...
- **Usability and reliability enhancements (2026-05-26)** — Resolved double log entries under launchd, added smart content pruning/prioritization to fit formatting under 1200-char limits, updated preflight checks (`check_setup.py`) with run history, pmset wake schedule check, and interactive Keychain configuration, and added `--reload` to plist installation.
